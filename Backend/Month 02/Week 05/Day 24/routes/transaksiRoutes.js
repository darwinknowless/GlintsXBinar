...
// router.put("/update/:id",transaksiValidator.update,TransaksiController.update); // If accessing localhost:3000/transaksi/update/:id, it will call update function in TransaksiController class
